...
const MarkBulkAttendance: React.FC<MarkBulkAttendanceProps> = ({
  ...
  const [dynamicPresentCount, setDynamicPresentCount] =
    React.useState(presentCount);
  const [dynamicAbsentCount, setDynamicAbsentCount] =
    React.useState(absentCount);
  ...
  // console.log("bulkAttendanceStatus---", bulkAttendanceStatus);
  return (
    <Box>
      <Modal
